...
const Directors = () => {
  const members = [
    ...
    },
    {
      ...
      description:
        'Jamey Campbell is Chief Operating Officer for <a href="https://cmda.org/"> Christian Medical &amp; Dental Associations (CMDA)</a> in Bristol, Tennessee. After nearly a decade as the organization’s Vice President for Stewardship Development, Jamey moved into the COO position on July 1, 2019.<br>Jamey has over 25 years of experience in communications and development. After obtaining his bachelor’s degree in communication from <a href="https://www.etsu.edu/ehome/">East Tennessee State University</a> in 1986, he began work in the commercial television field before beginning his career in corporate communications and development.<br>Prior to joining CMDA, Jamey was on staff with former U.S. Senate Majority Leader Dr. Bill Frist, East Tennessee State University Quillen College of Medicine, and <a href="https://www.precept.org/">Precept Ministries International.</a>.<br>Jamey and his wife Janeen are involved in their church where they teach a young adult Sunday School class and Jamey serves as a deacon. They have two adult children, Rachel and Emily, and one grandchild, Titus.<br>When not working, Jamey enjoys spending time with his family, photography, and traveling with Janeen.',
    },
    {
      name: 'Roger Redding',
