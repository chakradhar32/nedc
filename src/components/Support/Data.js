  ...
  return (
    <section>
      ...
      >
        ...
        <p>
          Include the NEDC in your will. Have your attorney add a charitable bequest for the NEDC to
          your will or estate plan. You can direct how you would like us to use your gift.
        </p>
        <p>
          Designate the NEDC as an insurance beneficiary. Designate the NEDC to receive all or part
          of the proceeds of a life insurance policy. To do this, just ask your insurance company
          for a beneficiary designation form.
        </p>
        <p>
          Include the NEDC in your retirement plan. Designate the NEDC to receive part or all of
        ...
        <p>
          Set up a trust benefiting the NEDC. Establishing a charitable remainder trust can provide
        ...
        <p>
          ...
          development office at (865) 777-2013 x3 or mmellinger@baby4me.net.
        </p>
      </div>
    </section>
  );
