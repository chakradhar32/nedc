...
const Staff = () => {
  const members = [
    ...
    },
    {
      ...
      image: '/images/staff/carol-new-pic-e1444676566773-150x150.jpeg'
    },
    {
      ...
      image: '/images/staff/SA-150x150.jpeg'
    },
    {
      name: 'Mark Mellinger',
    ...
    },
    {
      ...
      image: '/images/staff/Christa-150x150.jpeg'
    },
    {
      name: 'Lisa Kozsan, RN',
      position: 'Patient Coordinator',
      ...
      >
        ...
        <div sx={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', my: '3rem' }}>
          {members.map((member, index) => (
            <Member key={index} data={member} mode="dark" />
          ))}
        </div>
      </div>
    </section>
