...
const Faqs = () => {
  const data = [
    ...
    },
    {
      ...
      answer:
        'In an open relationship the donor and recipient families must approve each other. The open arrangement is then mediated by a third party so that all parties involved are clear on the level of communication they will share. If you choose to donate anonymously you are able to set certain stipulations for the recipient couple, such as, geographic location, religious preference, and education levels. The NEDC will honor your requests by selecting an anonymous family to receive your embryos.  The National Embryo Donation Center reserves the right to place certain restrictions on the adopting parents.',
    },
    {
      question: 'Are the adopting couples screened?',
      answer:
        'Yes, they are screened for infectious diseases, general and reproductive health, and their ability to successfully parent children. All adopting families must undergo and pass a home study in the state in which they reside.',
    },
    {
      question: 'Will we be responsible for our embryos or have parental rights?',
      answer:
        'Prior to donation, you will sign a form relinquishing your rights to your embryos and any children who are born from them. Your relinquishment does not officially begin until the embryos are physically transferred in to the recipient wife. At that time the adopting family receives all rights.',
    },
    {
      question:
        'Could the children from the embryo donation inadvertently meet their siblings andreproduce?',
      answer:
